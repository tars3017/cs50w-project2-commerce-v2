...
urlpatterns = [
    ...
    path("close_bid/<str:item_name>", views.close_bid, name="close_bid"),
    path("leave_comment/<str:item_name>", views.leave_comment, name="leave_comment"),
    path("my_bids", views.show_mybids, name="my_bids")
]
